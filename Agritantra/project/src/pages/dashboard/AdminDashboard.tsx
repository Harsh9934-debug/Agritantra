...
export const AdminDashboard: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'farms', label: 'Farms', icon: <Package className="h-5 w-5" /> },
    { id: 'devices', label: 'IoT Devices', icon: <Settings className="h-5 w-5" /> },
  ...
  const recentUsers = [
    { id: '1', name: 'Rajesh Kumar', email: 'rajesh@farmer.com', type: 'farmer', status: 'active', joinDate: '2025-01-15' },
    { id: '2', name: 'Priya Sharma', email: 'priya@buyer.com', type: 'buyer', status: 'active', joinDate: '2025-01-14' },
    { id: '3', name: 'Amit Patel', email: 'amit@farmer.com', type: 'farmer', status: 'pending', joinDate: '2025-01-13' }
  ];

  const recentOrders = [
    { id: '1', buyer: 'Fresh Mart', farmer: 'Rajesh Kumar', product: 'Tomatoes', amount: 15000, status: 'delivered' },
    { id: '2', buyer: 'Organic Store', farmer: 'Priya Sharma', product: 'Wheat', amount: 25000, status: 'shipped' },
    { id: '3', buyer: 'Local Market', farmer: 'Amit Patel', product: 'Rice', amount: 18000, status: 'confirmed' }
  ];
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{stats.activeDevices.toLocaleString()}</p>
                  </div>
                </div>
              </div>
